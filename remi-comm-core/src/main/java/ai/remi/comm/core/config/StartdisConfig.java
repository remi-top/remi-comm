 ...
 */
@Component
@ConfigurationProperties(prefix = "startdis")
public class StartdisConfig
{
    /** 项目名称 */
    private String name;
    ...
    {
        StartdisConfig.profile = profile;
    }
    ...
    {
        StartdisConfig.addressEnabled = addressEnabled;
    }
    ...
    public void setCaptchaType(String captchaType) {
        StartdisConfig.captchaType = captchaType;
    }
